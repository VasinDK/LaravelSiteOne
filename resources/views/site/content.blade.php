        ...
        <div class="hero_section">
          <div class="row">
            ...
            <div class="col-lg-7 col-sm-5">
             {!! Html::image('assets/img/'.$page->images) !!}  <!-- это то что мы добавили в начале дополнительным пакетом -->
        ...
        @foreach($peoples as $k=> $people)
          <div class="team_area">
            <div class="team_box wow fadeInDown delay-{{ ($k*3 + 3) }}s">
              ...
              {{ Html::image('assets/img/'. $people->images, $people->name) }} <!-- второй атребут это тег альт -->
